...
class LowLevelMovementSystem:
    ...
    def __init__(self, config: Any, perf_monitor: Any) -> None:
        ...
        # Pre-calculate scaling factors to replace division in hot path (OPTIMIZATION)
        # Clamp dimensions to avoid ZeroDivisionError
    ...
    def move_mouse_absolute(self, x: int, y: int) -> bool:
        ...
        try:
            ...
            # OPTIMIZATION: Use pre-calculated scaling and int casting for speed
