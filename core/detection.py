...
class DetectionSystem:
    ...
    def _detect_in_area(self, left: int, top: int, width: int, height: int) -> tuple[bool, int, int]:
        """
        Helper method to detect target in a specific area.
        Returns (found, screen_x, screen_y).
        Does NOT update instance state (target_x, target_y, target_found_last_frame).
        """
        ...
        # Use cached bounds
        # Lazy load if needed (though find_target handles this usually)
