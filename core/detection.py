...
class DetectionSystem:
    ...
    def _scan_region(
        ...
        """
        Shared logic for capturing and scanning a screen region.
        Consolidates duplication from local and full search.
        """
        width = right - left
        height = bottom - top
    ...
    def _full_search(
        ...
        found, screen_x, screen_y = self._scan_region(left, top, right, bottom)
