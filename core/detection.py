...
class DetectionSystem:
    ...
    def _scan_region(self, left: int, top: int, width: int, height: int) -> tuple[bool, int, int, bool]:
        """
        Scans a specific region for the target color.
    ...
    def _local_search(self) -> tuple[bool, int, int]:
        ...
        found, screen_x, screen_y, success = self._scan_region(local_left, local_top, width, height)
    ...
    def _full_search(self, left: int, top: int, right: int, bottom: int) -> tuple[bool, int, int]:
        ...
        found, screen_x, screen_y, success = self._scan_region(left, top, width, height)
