...
class DetectionSystem:
    ...
    def _detect_in_area(self, left: int, top: int, width: int, height: int) -> tuple[bool, int, int]:
        """
        Consolidated detection logic for arbitrary screen areas.
        Handles capture, color bounding, masking, and location finding.
        ...
        Returns:
            Tuple of (success, screen_x, screen_y)
        """
    ...
    def _local_search(self) -> tuple[bool, int, int]:
        ...
        # Use consolidated detection logic
