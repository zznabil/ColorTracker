...
class DetectionSystem:
    ...
    def _detect_in_area(self, left: int, top: int, width: int, height: int) -> tuple[bool, int, int]:
        """
        Unified detection logic for a specific area.

        Args:
            left: Left coordinate of search area
            top: Top coordinate of search area
            width: Width of search area
            height: Height of search area

        Returns:
            Tuple of (found, screen_x, screen_y).
            Does NOT update instance state (target_found_last_frame, etc).
        """
