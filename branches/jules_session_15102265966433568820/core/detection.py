...
class DetectionSystem:
    ...
    def _detect_in_area(self, left: int, top: int, width: int, height: int) -> tuple[bool, int, int]:
        """
        Helper to perform detection within a specific screen area.
        Consolidates logic from _local_search and _full_search.

        Args:
            left: Screen X coordinate of the area's top-left corner
            top: Screen Y coordinate of the area's top-left corner
